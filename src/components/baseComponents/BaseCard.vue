	...
	<div class="base-card-wrapper">
		...
		<div class="rating">
			...
			<div class="visual-rating">
				<RadioRating v-if="ifRating" :name="photo.name+1" title="Rating"  :ratingValue="ratingMainValue" @give-back-value="getMainValue" @change="emitData" />
				<RadioRating v-if="colourRating" :name="photo.name+2" title="Colour rating:" :ratingValue="ratingColourValue" @give-back-value="getColourValue" @change="emitData" />
				<RadioRating v-if="designRating" :name="photo.name+3" title="Design rating:" :ratingValue="ratingDesignValue" @give-back-value="getDesignValue" @change="emitData" />
			</div>
